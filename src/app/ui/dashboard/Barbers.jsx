      ...
      <section className="grid md:grid-cols-2 lg:grid-cols-3">
        <article className="card ring-2 ring-slate-800 max-w-md bg-base-100 shadow-xl m-4 text-center">
          ...
          <article className="card-body bg-white dark:bg-gray-900">
            <h2 className="text-center font-bold text-3xl text-gray-800 dark:text-gray-100">
              Jony
            </h2>
        ...
        <article className="card ring-2 ring-slate-800 max-w-md bg-base-100 shadow-xl m-4 text-center">
          ...
          <article className="card-body bg-white dark:bg-gray-900">
            ...
            <p className="text-gray-800 dark:text-gray-100">
              Barber profesional - Fundador de Barrio Fino.
            </p>
            <div className="card-actions justify-between mt-2">
              <button className="btn btn-outline btn-error">
                <FaInstagram />
        ...
        <article className="card ring-2 ring-slate-800 max-w-md bg-base-100 shadow-xl m-4 text-center">
          ...
          <article className="card-body bg-white dark:bg-gray-900">
            <h2 className="text-gray-800 dark:text-gray-100 text-center font-bold text-3xl">
              Juan Manuel
            </h2>
            <p className="text-gray-800 dark:text-gray-100">
              Barber profesional - Fundador de Barrio Fino.
            ...
            <div className="card-actions justify-between mt-2">
              <button className="btn btn-outline btn-error">
                ...
                <a
                  target="_blank"
                  href="https://www.instagram.com/lemosjuan23?igsh=Nnl2Y3B1OXphb2lr"
                >
                  Ver Perfil
                </a>
              </button>
              <button className="btn btn-outline btn-accent">
                ...
                <a
                  target="_blank"
                  href="https://wa.me/+5491141949307?text=Hola%20quiero%20solicitar%20un%20turno%20porfavor"
                >
                  Solicitar turno
                </a>
              </button>
