...
export default function Barbers() {
    return (
        <>
            <h2 className="text-3xl text-center font-bold m-2 text-gray-800 dark:text-gray-100">Barberos</h2>
            <section className="grid md:grid-cols-2 lg:grid-cols-3">
                <article className="card max-w-md bg-base-100 shadow-xl m-4 text-center">
                    ...
                    <article className="card-body">
                        <h2 className="text-gray-800 dark:text-gray-100 text-center font-bold text-3xl">Jony</h2>
                        ...
                        <div className="card-actions justify-between mt-2">
                            <button className="btn btn-outline btn-error">
                                <FaInstagram />
                                <a className="text-gray-800 dark:text-gray-100" target="_blank" href="https://www.instagram.com/jonimasna?igsh=MTR1ZW5rMmY3MDhvaQ==">Ver Perfil</a>
                            </button>
