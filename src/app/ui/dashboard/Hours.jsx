    ...
    return (
        <section className="card bg-slate-600 ring-2 ring-slate-800 p-6 rounded-lg w-11/12">
                ...
                <ul className="timeline timeline-vertical lg:timeline-horizontal">
                    ...
                    <li>
                        <hr />
                        <div className="timeline-start">Martes</div>
                        <div className="timeline-middle">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 20 20"
                    ...
                    <li>
                        <hr />
                        <div className="timeline-start">Miercoles</div>
                        <div className="timeline-middle">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 20 20"
                    ...
                    <li>
                        <hr />
                        <div className="timeline-start">Jueves</div>
                        <div className="timeline-middle">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 20 20"
                    ...
                    <li>
                        <hr />
                        <div className="timeline-start">Viernes</div>
                        <div className="timeline-middle">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 20 20"
                    ...
                    <li>
                        <hr />
                        <div className="timeline-start">Sabado</div>
                        <div className="timeline-middle">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 20 20"
                    ...
                    <li>
                        <hr />
                        <div className="timeline-start">Domingo</div>
                        <div className="timeline-middle">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 20 20"
