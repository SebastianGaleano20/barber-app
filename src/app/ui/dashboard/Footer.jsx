    ...
    <section className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
        <article className="sm:flex sm:items-center sm:justify-between">
            ...
            <ul class="flex flex-wrap items-center mb-6 text-sm font-medium text-gray-500 sm:mb-0 dark:text-gray-400">
                <li>
                    <a href="https://www.instagram.com/barriofino_barberia?igsh=N3Jmc3JxNmRyODF3" class="hover:underline me-4 md:me-6">Instagram</a>
                </li>
                <li>
        ...
        <span className="block text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href="https://sebastiang.netlify.app/" class="hover:underline">DraCode</a>. All Rights Reserved.</span>
    </section>
</footer>
  )
}